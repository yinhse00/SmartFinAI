            ...
            {processedResults._calculatedConsideration && (
              <div>
                ...
                <div className="text-xs text-green-700 bg-green-50 rounded p-2 border border-green-200">
                  ...
                  {userInputs?.amount && userInputs?.acquisitionPercentage && (
                    <div className="text-gray-600 text-xs">
                      Formula: {userInputs.amount.toLocaleString()} × {userInputs.acquisitionPercentage}% = {processedResults._calculatedConsideration.toLocaleString()}
                    </div>
                  )}
                </div>
              </div>
