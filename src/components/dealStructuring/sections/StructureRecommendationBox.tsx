      ...
      <CardContent className="flex-1 p-0 min-h-0">
        <ScrollArea className="h-full px-4 pb-4" type="always">
          <div className="space-y-4">
            <div>
              <h4 className="font-medium text-base mb-3">{results.structure.recommended}</h4>
              <p className="text-gray-600 text-sm leading-relaxed">{results.structure.rationale}</p>
            </div>
            
            {results.structure.alternatives.length > 0 && (
              <div>
                <h5 className="font-medium mb-3 text-sm">Alternative Structures</h5>
