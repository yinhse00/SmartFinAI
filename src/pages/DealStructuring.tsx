      ...
      <div className="container mx-auto px-4 py-4">
        ...
        <div className="space-y-6">
          ...
          {currentStep === 'analysis' && analysisResults && <div className="space-y-6">
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-4">
                  ...
                  {enhancedResults && <div className="flex items-center gap-2">
                      ...
                      {enhancedResults.optimization.marketIntelligence.precedentTransactions.length > 0 && <div className="flex items-center text-blue-600 text-sm">
              ...
              <DealStructuringDashboard results={analysisResults} onResultsUpdate={handleResultsUpdate} optimizationResult={enhancedResults?.optimization} />
            </div>}
        </div>
      </div>
    </MainLayout>;
