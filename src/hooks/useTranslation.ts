...
interface UseTranslationProps {
  initialSourceLang?: 'en' | 'zh';
  initialTargetLang?: 'en' | 'zh';
}
...
export const useTranslation = ({ 
  ...
  const [sourceLanguage, setSourceLanguage] = useState<'en' | 'zh'>(initialSourceLang);
  const [targetLanguage, setTargetLanguage] = useState<'zh' | 'en'>(initialTargetLang);
