...
/**
 * Use Grok Vision to extract text from documents
 */
export const useGrokVisionProcessor = async (file: File, documentType: string): Promise<{ content: string; source: string }> => {
  try {
