...
DROP POLICY IF EXISTS "Public read access for vetting requirements" ON public.announcement_pre_vetting_requirements;
...
DROP POLICY IF EXISTS "Public read access for new FAQ" ON public.listingrule_new_faq;
...
DROP POLICY IF EXISTS "Public read access for timetable" ON public.listingrules_listed_timetable;
